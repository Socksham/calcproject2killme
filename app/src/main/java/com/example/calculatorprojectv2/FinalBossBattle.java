...
public class FinalBossBattle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_final_boss_battle);
        ...
        count = new CountDownTimer(45000, 1000) {
    ...
    private void playMusic(){
        if (backgroundMusic == null){
            backgroundMusic = MediaPlayer.create(this, R.raw.survive_the_swordland);
